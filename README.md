...
Deploy TriviaBot to the cloud in minutes with no server management!

**[📚 Full Railway Deployment Guide](DEPLOY_RAILWAY.md)**

Quick steps:
1. Fork this repository on GitHub
2. Connect to [Railway.app](https://railway.com)
3. Add your Discord Bot Token as environment variable
4. Done! Railway auto-deploys on every push

## Self-Hosted Installation
If you'd like to install and host TriviaBot yourself on your own server, you can find out how to do so [here](http://lakeys.net/triviabot/install.html).
