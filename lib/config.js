...
module.exports = (configFile, displayWarnings) => {
  ...
  // Read from environment variables and override config values
  ...
  if(process.env.DISCORD_SHARD_COUNT) {
    Config["shard-count"] = process.env.DISCORD_SHARD_COUNT;
  }
  if(process.env.DEBUG) {
    Config["debug-mode"] = process.env.DEBUG === "true";
  }
